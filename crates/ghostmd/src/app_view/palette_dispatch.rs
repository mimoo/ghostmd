...
impl GhostAppView {
    pub(crate) fn palette_commands() -> Vec<PaletteCommand> {
        vec![
            ...
            PaletteCommand { label: "Theme: Gruvbox".into(), shortcut_hint: None, action_id: "theme_gruvbox".into() },
            PaletteCommand { label: "Theme: Catppuccin".into(), shortcut_hint: None, action_id: "theme_catppuccin".into() },
            PaletteCommand { label: "Theme: Tokyo Night".into(), shortcut_hint: None, action_id: "theme_tokyo_night".into() },
            PaletteCommand { label: "Theme: Kanagawa".into(), shortcut_hint: None, action_id: "theme_kanagawa".into() },
            PaletteCommand { label: "Theme: Everforest".into(), shortcut_hint: None, action_id: "theme_everforest".into() },
            PaletteCommand { label: "Theme: One Dark".into(), shortcut_hint: None, action_id: "theme_one_dark".into() },
            PaletteCommand { label: "Theme: Moonlight".into(), shortcut_hint: None, action_id: "theme_moonlight".into() },
            PaletteCommand { label: "Theme: Ayu Dark".into(), shortcut_hint: None, action_id: "theme_ayu_dark".into() },
            PaletteCommand { label: "Theme: Palenight".into(), shortcut_hint: None, action_id: "theme_palenight".into() },
            PaletteCommand { label: "Theme: Vesper".into(), shortcut_hint: None, action_id: "theme_vesper".into() },
